...
const AVAILABLE_SCOPES: ScopeOption[] = [
  ...
  { id: "tokens:import", label: "Import browser account", description: "Allows the Chrome extension to add or refresh the Google account signed in to its browser profile." },
