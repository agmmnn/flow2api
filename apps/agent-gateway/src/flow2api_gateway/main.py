"""Uvicorn entry: ``uvicorn flow2api_gateway.main:app``."""
import logging
...
app = FastAPI(
    ...
    lifespan=lifespan,
    # Operator UI: main Flow2API admin in apps/admin-web (Agent gateway tab), not Swagger here.
    docs_url=None,
    redoc_url=None,
)
app.add_middleware(
