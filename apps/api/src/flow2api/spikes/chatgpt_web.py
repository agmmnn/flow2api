...
DEFAULT_PROJECT = "Flow2API"
DEFAULT_SESSION = "flow2api-phase1"
...
async def inspect_chatgpt_web_backend(
    *,
    ...
    resolved_cli = _resolve_executable(cli_path, "FLOW2API_CHATGPT_IMAGEGEN_CLI", "chatgpt-imagegen")
...
async def run_chatgpt_web_spike(request: ChatGPTWebSpikeRequest) -> ChatGPTWebSpikeResult:
    ...
    async with _WEB_SLOT:
        with tempfile.TemporaryDirectory(prefix="flow2api-chatgpt-web-") as temp_name:
